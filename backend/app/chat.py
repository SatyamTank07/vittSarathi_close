...
def generate_chat_response(messages_history: list, new_user_message: str) -> str:
    ...
    langchain_messages.append(SystemMessage(content="You are a helpful AI assistant for vittSarathi, an application dealing with financial and stock data. Be concise and informative."))
